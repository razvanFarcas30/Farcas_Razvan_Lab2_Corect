...
options.UseSqlServer(builder.Configuration.GetConnectionString("Farcas_Razvan_Lab2_incercareaNR2Context") ?? throw new InvalidOperationException("Connection string 'LibraryIdentityContextConnection' not found.")));
